   ...
   render() {
     return (
       <div className="boostScreen">
          ...
          <div> <input type="checkbox" onChange={() => {this.props.changePrayer('incrediblereflexes', !this.props.activePrayers.burstofstrength)}}/> Incredible Reflexes   {this.props.activePrayers.incrediblereflexes.toString()}</div>
